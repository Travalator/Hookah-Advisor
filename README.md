...
- Добавление возможности ведения личной истории пользователя. 
- Добавление возможности составлять рекомендации на основе истории пользователя (его предпочтениях).
- Увеличение точности рекомендательной функции за счет расширения базы данных, полученной за счет сбора информации от пользователей.
